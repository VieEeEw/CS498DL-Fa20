...
if not os.path.exists('./language_data'):
...
for file in files_list:
    ...
    new_train_file_name = f'language_data/train/{os.path.basename(file).split(".")[0]}_train.txt'
    new_test_file_name = f'language_data/test/{os.path.basename(file).split(".")[0]}_test.txt'
...
os.system(
    'wget -O language_data/kaggle_rnn_language_classification_test.txt '
    'https://uofi.box.com/shared/static/094rb0n0serfb1s19iwrvk0vwhf8bg6p.txt')
